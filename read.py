...
galaxy_naming = namedtuple('galaxy_data', ['current', 'next', 'previous', 'present_day', 'xcoord', 'ycoord', 'zcoord', 'stellar_mass', 'dark_matter_mass', 'black_hole_mass', 'gas_mass', 'acc_rate', 'density'])
